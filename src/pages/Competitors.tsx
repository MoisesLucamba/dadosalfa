...
// Operator data with comprehensive metrics
const operatorsData = [
  {
    id: 1,
    name: "TotalEnergies",
    ...
    production: 285,
    marketShare: 26.4,
    blocks: ["Bloco 17", "Bloco 32", "Bloco 14"],
    blocksCount: 3,
    employees: 3500,
    investmentYTD: 1.8,
    efficiency: 94,
  ...
  },
  {
    ...
    production: 175,
    marketShare: 16.2,
    blocks: ["Bloco 3", "Bloco 4", "Bloco 5/06"],
    blocksCount: 3,
    employees: 8500,
    investmentYTD: 0.9,
    efficiency: 86,
...
const marketShareHistory = [
  { year: "2020", TotalEnergies: 28, Chevron: 20, Sonangol: 18, ENI: 14, BP: 12, ExxonMobil: 8 },
  { year: "2021", TotalEnergies: 27, Chevron: 19, Sonangol: 17, ENI: 15, BP: 13, ExxonMobil: 9 },
  { year: "2022", TotalEnergies: 26.5, Chevron: 18.5, Sonangol: 16.5, ENI: 15.5, BP: 13.5, ExxonMobil: 9.5 },
  { year: "2023", TotalEnergies: 26.2, Chevron: 18.2, Sonangol: 16.3, ENI: 15.6, BP: 13.5, ExxonMobil: 10.2 },
